...
//        progress.setVisible(true);
        ...
        try {
            ...
            try {
                ...
                FXMLLoader loader = Operations.loadWindow(this.getClass(), "/FXML/client/clientLoggedIn.fxml", "Welcome", 650, 800);
                ...
                try {
                    user = login("staff", username, password);
                    // logged in as staff
//                    Operations.changeWindows(logInButton, "StaffLoggedIn", "FXML/staffLoggedIn.fxml", this.getClass(), 600, 600);
                    this.usernameField.getScene().getWindow().hide();
                    FXMLLoader loader = Operations.loadWindow(this.getClass(), "/FXML/staff/staffLoggedIn.fxml", "Staff", 600, 600);
...
//        progress.setVisible(false);
    ...
    void signUp(ActionEvent event) throws IOException {
        Operations.changeWindows(logInButton, "Sign Up", "/FXML/signUp.fxml", this.getClass(), 600, 550);
