...
public class StaffProducts implements Initializable {
    ...
    private VBox createProductVBox(Product product) {
        ...
        vbox.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
            ...
            loader.setLocation(getClass().getResource("/FXML/staff/staffChosenProduct.fxml"));
    ...
    void goToMainMenu(ActionEvent event) throws IOException {
        Operations.changeWindows(nameTextField, "Settings", "/FXML/staff/staffLoggedIn.fxml", this.getClass(), 600, 600);
